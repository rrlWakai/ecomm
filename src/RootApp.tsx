...
export default function RootApp() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f3] text-[#111111]">
      <header
        className={`sticky top-0 z-40 border-b transition-colors duration-500 ${brandHeaderClass}`}
      >
        <div className="mx-auto flex h-20 max-w-[1240px] items-center justify-between px-6 md:px-10">
          <Link to="/" className="text-sm tracking-[0.24em] uppercase">
            TechElite
          </Link>
          ...
          <div className="hidden items-center gap-5 text-sm md:flex">
                    ...
                    {user ? (
                      <>
                        ...
                        <button
                          ...
                          className="mt-2 w-full rounded border border-black/10 px-3 py-2 text-left text-sm hover:bg-black/5"
                        >
                          Sign Out
                        </button>
                      </>
            ...
            <Link
              to="/admin"
              className="text-xs tracking-[0.12em] uppercase text-[#666] hover:opacity-70"
            >
              Admin
            </Link>
          </div>
