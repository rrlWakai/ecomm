  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-8 py-32 overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1778287527407-1dc5ce1aa8e8?w=1920&q=90)',
        }}
      >
      ...
      >
        <p className="text-sm uppercase tracking-widest opacity-90 mb-6">Your Workspace</p>
        ...
        <p className="text-xl md:text-2xl font-light opacity-90 leading-relaxed">
          Precision-engineered displays for the work that matters.
        </p>
      </motion.div>
    </section>
  );
