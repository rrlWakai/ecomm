...
export type Database = {
  public: {
    Tables: {
      ...
      products: { Row: { id: string; name: string; slug: string; description: string | null; price: number; compare_price: number | null; stock: number; category_id: string | null; images: string[]; is_featured: boolean; is_active: boolean; created_at: string }; Insert: { id?: string; name: string; slug: string; description?: string | null; price: number; compare_price?: number | null; stock?: number; category_id?: string | null; images?: string[]; is_featured?: boolean; is_active?: boolean; created_at?: string }; Update: Partial<Database['public']['Tables']['products']['Insert']> };
    ...
    Functions: { get_dashboard_stats: { Args: Record<string, never>; Returns: { total_revenue: number; orders_today: number; new_customers_week: number; pending_orders: number; low_stock_count: number }[] } };
